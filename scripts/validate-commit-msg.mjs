...
const conventional =
  /^(feat|fix|docs|chore|refactor|test|ops|data|build|ci|perf|style)(\([a-z0-9-]+\))?: .{1,120}$/.test(firstLine);
...
if (!conventional && !mergeOrRevert) {
  ...
  console.error("Use Conventional Commits, for example: feat: add camera renderer");
  process.exit(1);
}
